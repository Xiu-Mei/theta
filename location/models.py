...
class Room(models.Model):
    ...
    name = models.CharField(max_length=512)  # room: 402a
    ...
    def __str__(self):
        return '{} {} {}'.format(self.floor, self.name, self.additional_name)
